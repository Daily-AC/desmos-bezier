...
打开页面，拖入一张图片——**或一段 GIF / MP4 / WebM**（自动逐帧矢量化后在图纸上播放，暂停的瞬间当前帧变成 Desmos 里可编辑的方程组，试试 Bad Apple）。想复现 README 里的效果：
...
| **视频**（GIF/MP4/WebM） | 逐帧矢量化预处理（≤12fps/≤120 帧），覆盖层播放，**暂停即方程**——暂停帧一键成为可编辑的 Desmos 状态 | 动画/剪影素材（Bad Apple 严选） |
