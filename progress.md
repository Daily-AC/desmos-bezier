...
- **对外发布(2026-07-11 凌晨)**:演示视频已推站点 https://desmos-bezier.lab.qmledmq.cn:8443/demo-video.mp4 (200/11MB);项目已建 GitHub 私有仓库 github.com/Daily-AC/desmos-bezier(main,含 README/全部测试资产/视频,.impeccable 已 ignore),黑客松如需公开评审可 `gh repo edit Daily-AC/desmos-bezier --visibility public --accept-visibility-change-consequences`。
